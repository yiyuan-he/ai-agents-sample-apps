...
# CrewAI Traceloop Traffic Generator
...
# Sample queries
QUERIES=(
    "What are the key trends in artificial intelligence and how can businesses leverage them?"
    "Analyze the impact of cloud computing on modern business operations"
    "What are the benefits and challenges of implementing edge computing?"
    "How is quantum computing expected to transform various industries?"
    "Explain the role of DevOps in modern software development"
    "What are the security implications of widespread IoT adoption?"
    "Analyze the future of remote work and its impact on businesses"
    "How can companies effectively implement data governance strategies?"
    "What are the emerging trends in cybersecurity for 2024?"
    "Explain the importance of API-first design in modern applications"
)
...
# Main execution
main() {
    echo -e "${BLUE}=== CrewAI Traceloop Traffic Generator ===${NC}"
